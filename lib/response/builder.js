    ...
    return {
        ...
        speechless: async ( handlerInput, data, options ) => {
            ...
            if ( data ) {
                ...
                } else if ( options && options.repeatOutput ) {
                    sessionAttributes[ e.attr.SPEECH_OUTPUT ] = options.repeatOutput.output || null;

                    if ( options.repeatOutput.reprompt ) {
                        sessionAttributes[ e.attr.SPEECH_REPROMPT ] = options.repeatOutput.reprompt || null;
                    } else {
                        delete sessionAttributes[ e.attr.SPEECH_REPROMPT ];
                    }
                } else {
