...
const analyticsHandlers = {
    ...
    "sendResponseTracking": function( data, options, cb ) {
        ...
        } else if ( analyticsUtils.getProvider() === e.analyticsProvider.DASHBOT && analyticsUtils.isTrackableRequest( this.event ) ) {
    ...
    "sendEvent": function( event, trackingEvent, trackingParams, cb ) {
        ...
        } else if ( analyticsUtils.getProvider() === e.analyticsProvider.DASHBOT &&  analyticsUtils.isTrackableRequest( event ) && trackingEvent ) {
