...
const analytics = {
    ...
    "sendRequestTracking": {
        process( handlerInput ) {
            if ( provider && handlerInput && handlerInput.requestEnvelope && analyticsUtils.getProvider() === e.analyticsProvider.DASHBOT ) {
    ...
    "sendResponseTracking": {
        async process( handlerInput ) {
            //TODO: confirm events aren't being sent in triplicate
