 ...
 *
 */
const c = require("./../constants"), err = require("./../errors"), request = require("request"), utils = require("./../utils/utils");
/**
 *  Private Methods
 */
const dashbotUtils = {
    buildEvent: function (event, trackingEvent, trackingParams) {
        const sessionId = utils.getSessionId(event, null), userId = utils.getUserId(event, null);
