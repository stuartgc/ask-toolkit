"use strict";
const c = require("./../constants"), DynamoDbPersistenceAdapter = require("ask-sdk-dynamodb-persistence-adapter").DynamoDbPersistenceAdapter, utils = require("./../utils/utils");
